...
if not (llama_cloud_key and groq_key and openai_key):
    raise ValueError(
...
embed_model_name = "text-embedding-ada-002"  # OpenAI embedding model
...
embed_model = OpenAIEmbedding(api_key=openai_key, model_name=embed_model_name)
